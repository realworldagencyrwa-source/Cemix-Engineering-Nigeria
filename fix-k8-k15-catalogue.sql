-- Add is_catalogue column to products table
ALTER TABLE products ADD COLUMN IF NOT EXISTS is_catalogue boolean DEFAULT false;

-- Update K8-K15 product to be a catalogue type with image
UPDATE products
SET
